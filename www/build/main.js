...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_checklist_service_checklist_service__ = __webpack_require__(47);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_checklist_service_checklist_service__ = __webpack_require__(47);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var RegisterPage = /** @class */ (function () {
    ...
    RegisterPage.prototype.register = function (m, id, name, fauctly, major, email, password, confirmPassword) {
        var _this = this;
        var data = {
            student_id: id,
            student_name: m + name,
                ...
                buttons: [
                    {
                        ...
                        role: 'cancel',
                        handler: function () {
                            _this.addUser(m, id, name, fauctly, major, email, password);
                        }
                    }
                ]
            });
    ...
    RegisterPage.prototype.addUser = function (m, id, name, fauctly, major, email, password) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.checklistservice.createUser(m, id, name, fauctly, major, email, password)];
                    case 1:
                        _a.sent();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__providers_checklist_service_checklist_service__ = __webpack_require__(47);
...
var ChecklistServiceProvider = /** @class */ (function () {
    ...
    ChecklistServiceProvider.prototype.createUser = function (m, id, name, fauctly, major, email, password) {
        var data = {
            student_id: id,
            student_name: m + name,
            fauctly: fauctly,
